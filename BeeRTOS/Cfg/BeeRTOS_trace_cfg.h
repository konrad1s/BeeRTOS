...
#define OS_TRACE_TICK(ticks) (void)ticks;
 ...
 */
#define OS_TRACE_TASK_CREATE(task, name, stack_size)     \
    do                                                   \
    {                                                    \
...
#define OS_TRACE_SEMAPHORE_BLOCKED(task) \
...
#define OS_TRACE_EXIT_ISR() \
    SEGGER_SYSVIEW_RecordExitISR()

/* @brief Records the timer start event */
#define OS_TRACE_ALARM_START(alarm_id, period, periodic) \
    {                                                    \
    }

/* @brief Records the timer stop event */
#define OS_TRACE_ALARM_CANCEL(alarm_id) \
    {                                   \
    }
